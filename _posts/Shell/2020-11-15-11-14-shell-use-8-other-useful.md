...
###### 3. Permission  
&nbsp;Script에서 지정한 경로에 위치하는 파일이나 폴더에 퍼미션 설정을 합니다.  
<br>
&nbsp;&nbsp;**3.1. Shell script**  
- **chmod _\<options\>_ ${mode} ${path}**
${path}에 위치한 파일이나 폴더의 Mode를 ${mode} 값으로 변경합니다. 아래는 옵션에 관한 내용입니다.
    ...
    |-R <br> --recursive|명시한 ${path}와 그 하위에 있는 파일, 폴더에 재귀적으로 변경합니다.|
    ...
    |:---:|:---:|:---:|:----|
    |-|0|000|없음. None|
    |x|1|001|실행 <br> 실행 또는 폴더 접근에 접근할 수 있습니다.|
