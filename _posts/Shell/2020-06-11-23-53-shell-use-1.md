...
###### 7. 변수 정의 및 사용
Script 내에서 변수를 정의하고 사용할 수 있다.  
- Shell script  
    다른 명령어 없이 변수명만 명시하면 변수를 정의할 수 있다. 정의할 때 변수의 초기값은 따로 지정하지 않아도 된다. 정의된 변수는 변수명 앞에 **$**을 붙여 사용할 수 있다. 
...
- Batch file  
    SET 명령어를 사용하여 변수를 정의할 수 있다. 정의할 때 변수의 초기값은 따로 지정하지 않아도 된다. 정의된 변수는 **%**로 변수명을 감싸 사용할 수 있다.
    - 변수 정의  
